...
Future<void> floodDatabase(int count) async {
  ...
  final titles = ['Flutter is cool', 'Why I love Dart', 'Help with Gradle', 'Orcanet Update', 'Coffee Break'];
  final subtitles = ['This is a test post body.', 'Lorem ipsum dolor sit amet.', 'Just testing the infinite scroll.', 'Anyone else having this bug?', 'Hello world!'];
  final pods = ['Orcas', 'Dolphins', 'Whales', 'Students'];
  final tags = ['Flutter', 'Dart', 'Bug', 'Feature', 'Life', 'School'];
  final uids = ['2u6hqirtZTdl7gBI85wUap9qJni1', 'testUser1', 'testUser2']; // Use REAL UIDs if you want profiles to load!
  ...
  for (int i = 0; i < count; i++) {
    ...
    Map<String, dynamic> fakePost = {
      ...
      'sednerUid': uids[random.nextInt(uids.length)], // Keeping your typo 'sednerUid'
      'tags': [
